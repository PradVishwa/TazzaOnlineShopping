            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light  py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="fs-2 m-0 text-light">Edit & Update User</h2>
                    </div>
                    <?php include("nav.php"); ?>
                </nav>
                <!-- nav bar content end  -->
                        ...
                        <form action="update_user.php" method="post">
                            <div class="row mt-5 ms-5 ">
                                <div class="col-md-5 my-4 cat">
                                    ...
                                    <input type="password" name="password" id="" class="form-control" value="<?php echo $row['password']; ?>">
                                    <input type="text" name="city" id="" class="form-control" value="<?php echo $row['city']; ?>">
