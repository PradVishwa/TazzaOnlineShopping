                ...
                <div class="col-12 contact-form ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6  admin">
                            <form action="change_pas_code.php" method="post">
                                <div class="col-md-6 mb-4 ">
                                    <input type="Password" name="op" id="" class="form-control" placeholder="Old Password " required>
                                </div>
                                <div class="col-md-6 mb-4">
                                ...
                                <div class="col-12 mb-4">
                                    <input type="submit" class="btn main-btn" value="Change">
                                </div>
                            </form>
                        </div>
                    </div>
